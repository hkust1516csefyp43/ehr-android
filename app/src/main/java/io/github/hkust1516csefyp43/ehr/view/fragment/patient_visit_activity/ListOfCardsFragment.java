...
import io.github.hkust1516csefyp43.ehr.pojo.patient_visit.ListOfCards;
 ...
 */
public class ListOfCardsFragment extends Fragment implements onSendData {
...
//        a.add("leg");
  ...
  public Object onSendData() {
    ListOfCards loc = new ListOfCards();
    if (adapter != null) {
      loc.setCardArrayList(adapter.getData());
    }
    return loc;
  }
}
