...
public class FragCardViewHolder extends RecyclerView.ViewHolder {
    ...
    public FragCardViewHolder(View view, final Context c, final ArrayList<String> suggestions, final String title, final FragRecyclerViewAdapter adapter) {
        super(view);
        cardTitle = (TextView) view.findViewById(R.id.medicineName);
        cardDescription = (TextView) view.findViewById(R.id.medicalDescription);
        cardSwitch = (SwitchCompat) view.findViewById(R.id.scNull);
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cardSwitch.isChecked()) {
                    final TwoEditTextDialogCustomView tetdcv = TwoEditTextDialogCustomView.newInstance(c, suggestions, title, cardTitle.getText().toString(), cardDescription.getText().toString());
