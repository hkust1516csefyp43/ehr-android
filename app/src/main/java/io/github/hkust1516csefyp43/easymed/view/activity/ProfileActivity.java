...
public class ProfileActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (toolbar != null) {
      ...
      if (actionBar != null) {
        actionBar.setTitle("Tem Channat");            //TODO if user != null
    ...
    if (ivProfilePic != null) {
      ivProfilePic.setImageDrawable(TextDrawable.builder().buildRect("TC", ColorGenerator.MATERIAL.getColor("Tem Channat")));
    }
